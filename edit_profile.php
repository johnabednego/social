...
$number_save=$_POST['number'];
	...
	mysqli_query($link,"UPDATE user SET firstname ='$first_save', lastname ='$last_save', username ='$username_save', 
	birthday ='$birthday_save' , gender ='$gender_save', num ='$number_save' WHERE id = '$id'")
				or die(mysqli_error()); 
	echo "Saved!";
